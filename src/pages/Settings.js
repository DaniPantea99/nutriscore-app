...
function Settings() {
  ...
  const languages = [
    { key: 'en', value: `${t('settingsPage.languageList.en')}` },
    { key: 'ro', value: `${t('settingsPage.languageList.ro')}` },
  ];
  ...
  return (
    <div className="h-full p-4 duration-100 sm:p-8 dark:text-gray-100 dark:bg-slate-900">
      <div className="py-2 mb-4">
        <img
          className="inline mr-2"
          width="50px"
          src="./images/nutriscore-app-logo.png"
          alt="nutriscore-app-logo"
        />
      ...
      <div className="p-4 bg-white dark:bg-slate-800 flex flex-col rounded-xl sm:w-[500px] gap-4">
        <Combobox
          value={
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="relative w-40 mt-1 sm:w-52">
              <div className="relative w-full text-left rounded-lg shadow-md cursor-default sm:text-sm">
                <Combobox.Input className="w-full py-2 pl-3 pr-10 overflow-hidden text-sm leading-5 text-white border-none rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600 bg-gradient-to-t from-blue-300 to-blue-500 hover:bg-gradient-to-t hover:from-blue-300 hover:to-blue-400" />
                ...
                <Combobox.Options className="absolute z-10 w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-1 sm:text-sm">
                  {filteredLanguages.length === 0 && query !== '' ? (
                    <div className="relative px-4 py-2 text-gray-700 cursor-default select-none">
                      {t('settingsPage.noLanguageFound')}
                    </div>
                  ) : (
